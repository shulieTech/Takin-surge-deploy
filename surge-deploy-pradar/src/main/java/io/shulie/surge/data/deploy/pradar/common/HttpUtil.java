...
public class HttpUtil {
    ...
    public static String sendPost(String urlOri, Object object) {
        return sendPost(urlOri, object, 30000);
    }

    public static String sendPost(String urlOri, Object object, int timeout) {
        try {
            ...
            if (HttpURLConnection.HTTP_OK == conn.getResponseCode()) {
                ...
                logger.error("请求失败:Url:{}, Params:{}, ResponseCode:{}, ResponseMessage:{}", urlOri, object,
    ...
    public static String sendGet(String urlOri, Object object) {
        StringBuffer sb = new StringBuffer();
        try {
            if (!urlOri.endsWith("?")) {
                urlOri += "?";
            }
            urlOri += parseParams(object);
            // 创建url资源
            URL url = new URL(urlOri);
            // 建立http连接
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
