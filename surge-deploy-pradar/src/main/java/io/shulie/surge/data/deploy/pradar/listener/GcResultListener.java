 ...
 */
@Singleton
public class GcResultListener implements DefaultAggregator.ResultListener {
    private static Logger logger = LoggerFactory.getLogger(GcResultListener.class);
    ...
    public boolean fire(Long slotKey, Metric metric, CallStat callStat) {
        try {
            ...
            fields.put("youngGcCount", callStat.get(0));
            fields.put("oldGcCount", callStat.get(1));
            fields.put("youngGcTime", callStat.get(2));
            fields.put("oldGcTime", callStat.get(3));
