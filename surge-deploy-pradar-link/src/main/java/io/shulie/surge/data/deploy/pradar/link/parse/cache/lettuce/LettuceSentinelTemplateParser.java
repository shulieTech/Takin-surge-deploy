...
import com.pamirs.attach.plugin.dynamic.template.RedisTemplate.LettuceSentinelTemplate;
...
public class LettuceSentinelTemplateParser extends AbstractTemplateParser {
    ...
    public Class<?> supportTemplateClass() {
        return LettuceSentinelTemplate.class;
    }

    @Override
    public ShadowDatabaseParseResult doParseTemplate(TTrackClickhouseModel traceModel,
        TemplateEnum templateEnum) {
        Attachment<LettuceSentinelTemplate> attachment = JSON.parseObject(
            TemplateParseHandler.detachAttachment(traceModel),
            new TypeReference<Attachment<LettuceSentinelTemplate>>() {});
        LettuceSentinelTemplate template = attachment.getExt();
