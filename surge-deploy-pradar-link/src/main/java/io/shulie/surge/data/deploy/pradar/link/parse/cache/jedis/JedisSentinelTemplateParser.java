...
import com.pamirs.attach.plugin.dynamic.template.RedisTemplate.JedisSentinelTemplate;
...
public class JedisSentinelTemplateParser extends AbstractTemplateParser {
    ...
    public Class<?> supportTemplateClass() {
        return JedisSentinelTemplate.class;
    }

    @Override
    public ShadowDatabaseParseResult doParseTemplate(TTrackClickhouseModel traceModel,
        TemplateEnum templateEnum) {
        Attachment<JedisSentinelTemplate> attachment = JSON.parseObject(
            TemplateParseHandler.detachAttachment(traceModel),
            new TypeReference<Attachment<JedisSentinelTemplate>>() {});
        JedisSentinelTemplate template = attachment.getExt();
