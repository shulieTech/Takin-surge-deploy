...
public class HikariTemplateParser extends AbstractTemplateParser {
    ...
    public Pair<ShadowDatabaseModel, ShadowBizTableModel> doParseTemplate(TTrackClickhouseModel traceModel,
        ...
        Attachment<HikariTemplate> attachment = JSON.parseObject(TemplateParseHandler.detachAttachment(traceModel),
            new TypeReference<Attachment<HikariTemplate>>() {});
        HikariTemplate template = attachment.getExt();
