...
import io.shulie.takin.kafka.receive.constant.SceneManageStatusEnum;
import io.shulie.takin.kafka.receive.dto.web.PerformanceBaseDataReq;
import io.shulie.takin.kafka.receive.dto.web.PerformanceThreadDataVO;
import io.shulie.takin.kafka.receive.dto.web.TenantCommonExt;
import io.shulie.takin.kafka.receive.entity.*;
import io.shulie.takin.kafka.receive.dao.web.PerformanceThreadDataMapper;
import io.shulie.takin.kafka.receive.service.*;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import io.shulie.takin.kafka.receive.util.InfluxDatabaseWriter;
    ...
    private void influxWriterThread(PerformanceBaseDataReq param, Long baseId, TenantCommonExt dealHeader) {
        ...
        if (stackDataEntities.size() > 40) {
            for (List<PerformanceThreadStackData> entityList : ListUtil.split(stackDataEntities, 40)) {
                ...
                iPerformanceThreadStackDataService
            }
        } else {
