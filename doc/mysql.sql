...
(
    ...
    PRIMARY KEY (`id`),
    UNIQUE KEY `idx_unique1` (`app_name`, `agent_id`, `ip`, `pid`),
...
(
  ...
  DEFAULT CHARSET = latin1 COMMENT ='应用实例探针状态表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_bin COMMENT ='应用服务指标';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='链路表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='链路节点';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='链路节点关系';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='订阅信息表';
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='链路梳理-链路配置表';
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='链路梳理-链路边信息';
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='链路入口服务表';
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='链路梳理-链路节点表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='规则引擎表';
