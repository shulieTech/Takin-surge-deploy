...
ALTER TABLE t_trace_all ADD COLUMN flag Nullable(String);
ALTER TABLE t_trace_all ADD COLUMN flagMessage Nullable(String);
ALTER TABLE t_trace_all ADD COLUMN taskId Nullable(String);
ALTER TABLE t_trace_all ADD COLUMN receiveTime Nullable(Int64);
ALTER TABLE t_trace_all ADD COLUMN processTime Nullable(Int64);
ALTER TABLE t_trace_all ADD COLUMN saveCkTime DateTime DEFAULT now();