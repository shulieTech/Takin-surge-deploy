...
public interface DataQueue<IN extends Serializable, OUT extends Serializable> extends Lifecycle {
     ...
     * @return
     */
    boolean removeDelay(Map<String, Object> header, long eventTime, long processTime, String log);
     ...
     * @return
     */
    boolean checkDelay(Map<String, Object> header, long eventTime, long processTime, String log);
