 ...
 * @author vincent
 */
public class ClickHouseShardSupportSpec implements GenericFactorySpec<ClickHouseShardSupport> {
    private String url;
    ...
    public String factoryName() {
        return "DefaultClickHouseShard";
    }

    @Override
    public Class<ClickHouseShardSupport> productClass() {
        return ClickHouseShardSupport.class;
    }
