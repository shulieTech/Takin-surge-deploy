 ...
 * @desc 链路梳理相关功能模块
 */
public class PradarLinkLocalTopology {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (inputMap.containsKey(ParamUtil.TOPOLOGY_NAME)) {
            cluster.submitTopology(inputMap.get(ParamUtil.TOPOLOGY_NAME), config, topologyBuilder.createTopology());
        } else {
            cluster.submitTopology(PradarLinkLocalTopology.class.getSimpleName(), config, topologyBuilder.createTopology());
        }
    }
}
